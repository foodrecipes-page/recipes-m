...
Recipe cache shard for **[foodrecipes.page](https://foodrecipes.page)** — AI-generated recipes whose slug starts with **the letter 'm'**.
...
```
https://cdn.jsdelivr.net/gh/foodrecipes-page/recipes-m@main/recipes/<cuisine>/<diet>/<slug>.json
```
